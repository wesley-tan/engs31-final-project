...
##====================================================================
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {oscilliscope_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {oscilliscope_out}]
###Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {Rx_done}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Rx_done}]
###Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {valid}]					
